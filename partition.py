...
#        result = kk.karmarkar_karp(algs[algorithm](input_file))
        result = standard_algs.solution_to_residue(algs[algorithm](input_file))
    else:
#        result = kk.karmarkar_karp(prepartition_algs.prepartition_to_standard(algs[algorithm](input_file)))
         result = standard_algs.solution_to_residue(prepartition_algs.prepartition_to_standard(algs[algorithm](input_file)))
